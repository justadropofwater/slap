...
class Pane extends BaseWidget {
  constructor(opts) {
    var headerBottom = Slap.global.header.options.headerPosition === 'bottom' ? 1 : 0;
    var terminal = Slap.global.terminal;
    var terminalBottom = terminal && terminal.visible ? terminal.height : headerBottom;
    super(_.merge({
